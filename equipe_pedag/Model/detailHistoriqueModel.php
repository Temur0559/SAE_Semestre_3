...
class detailHistoriqueModel
{
    ...
    // Récupérer les informations lié a un justificatif
    public function detailParJustificatif(int $idJustificatif): array {
        $sql = "SELECT DISTINCT hd.id, hd.date_action, hd.action, hd.motif_decision, u.prenom AS etu_prenom, u.nom AS etu_nom 
