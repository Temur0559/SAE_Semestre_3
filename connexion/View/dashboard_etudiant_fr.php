...
if (!isset($_SESSION['identifiant'], $_SESSION['role']) || $_SESSION['role'] !== 'ETUDIANT') {
    header('Location: login_fr.php'); exit;
}
...
<header class="app-header-nav">
    <div class="header-inner-content">
        ...
        <div class="header-nav-links">
            <a href="<?= BASE_PATH ?>/connexion/View/dashboard_etudiant_fr.php" class="btn active-btn">Accueil Étudiant</a>
        ...
        <div class="user-info-logout">
            ...
            <!-- BOUTON DE LANGUE -->
            <a href="dashboard_etudiant_en.php" class="lang-switch-btn">🇬🇧 English</a>
